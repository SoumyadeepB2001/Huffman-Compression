...
public class HuffmanEncoder {
    ...
    // Public method to be called from another class
    public static boolean compressFile(File inputFile, String outputPath) {
        try {
            ...
            // Step 5: Write output
            writeHuffFile(outputPath, extension, paddingOut[0], freq, encodedData);
